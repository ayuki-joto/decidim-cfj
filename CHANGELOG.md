...
## [1.2.0](https://github.com/ayuki-joto/decidim-cfj/compare/v1.1.0...v1.2.0) (2024-05-24)


### Features

* add break line ([2fc0ca2](https://github.com/ayuki-joto/decidim-cfj/commit/2fc0ca22b41da50ef964b177da4437188c4504dd))
* add break line ([efc5a6d](https://github.com/ayuki-joto/decidim-cfj/commit/efc5a6d59078b7891adbddd682ad7f0a591a71dd))
* add break line ([1d2f5e3](https://github.com/ayuki-joto/decidim-cfj/commit/1d2f5e3cc24d38fee0987d6da5901179e8b80dc0))
* add break line ([5b852d8](https://github.com/ayuki-joto/decidim-cfj/commit/5b852d8a75e7a4613a629ce7a82f0c3ee505d701))
* add cdk deploy ([027d21c](https://github.com/ayuki-joto/decidim-cfj/commit/027d21cdd876bd8523a13df89c7af81c8d7dd3bb))
* add comment orderable params ([cec48d2](https://github.com/ayuki-joto/decidim-cfj/commit/cec48d297ddbb3a56e4301287512c103ec37d070))
* add curl ([512c4c1](https://github.com/ayuki-joto/decidim-cfj/commit/512c4c1c47af992d192b37bb0404aadf0e65835a))
* add decidim commets spec ([f3c4aba](https://github.com/ayuki-joto/decidim-cfj/commit/f3c4aba65042766f6b30f9c97ff8ad9cbba71ba3))
* add decidim migrate ([6bd4d1f](https://github.com/ayuki-joto/decidim-cfj/commit/6bd4d1fa17c7244a1573eafb2bf498333c97cdd3))
* add decidim-navigation-maps ([55c318b](https://github.com/ayuki-joto/decidim-cfj/commit/55c318b35364b026f6bc97aa53cbeba567ed2a54))
* add geo cording osm ([72cfb20](https://github.com/ayuki-joto/decidim-cfj/commit/72cfb206603668000a7376fedc5eb46104b909b0))
* add missing migrate file ([9cfddd3](https://github.com/ayuki-joto/decidim-cfj/commit/9cfddd37bbfc6a98cba4bc20850fad6e2281934c))
* add print css ([ce7477d](https://github.com/ayuki-joto/decidim-cfj/commit/ce7477d4c7510f935da178fa5626d7578ba787aa))
* add puma_worker_killer ([3c35f0b](https://github.com/ayuki-joto/decidim-cfj/commit/3c35f0b3facffcee125eb5ea1dc1801601884924))
* add puma_worker_killer config ([6b801a1](https://github.com/ayuki-joto/decidim-cfj/commit/6b801a1ae7cd0410a1708cf3e781ca12eca4f293))
* add replace to null decidim_organization command ([ea559b3](https://github.com/ayuki-joto/decidim-cfj/commit/ea559b33afbf06eed69b3342125d000c551c1856))
* add replace to null decidim_proposals command ([0037abe](https://github.com/ayuki-joto/decidim-cfj/commit/0037abee5c6f42fcc3b72c99bb971e2f072a2840))
* add replace to null ParticipatoryProcess command ([64da281](https://github.com/ayuki-joto/decidim-cfj/commit/64da28192ff22fdd5f4639dc971116644d4b26e7))
* add slack env ([67895f7](https://github.com/ayuki-joto/decidim-cfj/commit/67895f72a3d11671c6aac68d99157a559474e8b5))
* add support for heic format ([44aff59](https://github.com/ayuki-joto/decidim-cfj/commit/44aff59371a518b391e7f28a5ede8c1d9026f0f3))
* add working_dir ([2b06cc2](https://github.com/ayuki-joto/decidim-cfj/commit/2b06cc26a81b69105325fa15f0f0df7fdf38a3a2))
* apply new editor changes ([01bc7b2](https://github.com/ayuki-joto/decidim-cfj/commit/01bc7b2d4a5b0077f8c373e77b3ea0b2f747b9f0))
* change term_customizer branch ([0566f36](https://github.com/ayuki-joto/decidim-cfj/commit/0566f360024cf8664933df6e8c67eea72106c63d))
* create local docker nginx conf ([f76f4c4](https://github.com/ayuki-joto/decidim-cfj/commit/f76f4c4ef79f199ad2a9a6191c93b3fae18446bc))
* remove build_image workflow ([44f2aae](https://github.com/ayuki-joto/decidim-cfj/commit/44f2aaed63fda44a78aa140853bbd8a716d8d9db))
* update CHANGELOG.md ([348457c](https://github.com/ayuki-joto/decidim-cfj/commit/348457cb3e91744b96b9b6349def0ad61ee0f1da))
* update CHANGELOG.md ([c177955](https://github.com/ayuki-joto/decidim-cfj/commit/c1779550b69cdc543d84913c53ccc675dce5bdc5))
* update decidim v0.27.3 ([2b805fe](https://github.com/ayuki-joto/decidim-cfj/commit/2b805feee8e3b1d115931d54c16865f98c9cd5b3))
* update decidim version ([7f052b8](https://github.com/ayuki-joto/decidim-cfj/commit/7f052b8c8486291547ecb8be9ce7829d39d2b472))
* update decidim-comments v0.27.3 ([73e7f5f](https://github.com/ayuki-joto/decidim-cfj/commit/73e7f5fd0667ee5f8a0ab456ad74dbb556d42ae9))
* update decidim-comments v0.27.4 ([ceac57f](https://github.com/ayuki-joto/decidim-cfj/commit/ceac57f8aeb7171bf2a1a0df19883230a5da8ebf))
* update decidim-polis ([d3911c8](https://github.com/ayuki-joto/decidim-cfj/commit/d3911c8e51cefbac9388be94042a28cfbceaccc3))
* update decidim-user_extention ([2018884](https://github.com/ayuki-joto/decidim-cfj/commit/2018884df0c6bc0d38ba1a221f16e1cd3bb70d7f))
* update locales ([f6d4f83](https://github.com/ayuki-joto/decidim-cfj/commit/f6d4f83aa63c91b531f9bb79d300775aec39eec0))
* update packages ([64aab2e](https://github.com/ayuki-joto/decidim-cfj/commit/64aab2e515462fda972b5d0a1f5883a745592257))
* update packages ([9d4d43e](https://github.com/ayuki-joto/decidim-cfj/commit/9d4d43ef5a2b787f42c0eab7b498f95489220b48))
* update production v0252 ([87fdf66](https://github.com/ayuki-joto/decidim-cfj/commit/87fdf668e0c93332433e597564085117876c9315))
* update sidekiq version ([7a6381f](https://github.com/ayuki-joto/decidim-cfj/commit/7a6381f27765b7aeca9049023634004b1468d350))
* update version ([488ed12](https://github.com/ayuki-joto/decidim-cfj/commit/488ed12c440f4f797eb8dc572ac816811468ee7c))


### Bug Fixes

* 446; set `max_complexity` after initializers ([4adbf24](https://github.com/ayuki-joto/decidim-cfj/commit/4adbf24f04480826d543fd07c95dc667ecfff5fb))
* action add secret ([f1524e7](https://github.com/ayuki-joto/decidim-cfj/commit/f1524e76182b200494acf6985ed8b22ea5321531))
* action output name ([246679e](https://github.com/ayuki-joto/decidim-cfj/commit/246679e8382aa25204db9b364aa087df80ad0b11))
* action output step name ([2297bda](https://github.com/ayuki-joto/decidim-cfj/commit/2297bda8fd402168865bf2703345e58e3d61fdfa))
* add action needs ([a553285](https://github.com/ayuki-joto/decidim-cfj/commit/a553285a64955cd611cb8d1c0f93193ce8d567e2))
* add curl to container ([843194d](https://github.com/ayuki-joto/decidim-cfj/commit/843194d847be5518f368264e4fb5bbe6517e3fd8))
* add Decidim::Verifications::CsvDatum ([d5ad85f](https://github.com/ayuki-joto/decidim-cfj/commit/d5ad85f979cb292334b0d941ca3c56340fcbf829))
* add libs ([bfbfff3](https://github.com/ayuki-joto/decidim-cfj/commit/bfbfff34856529c799c788b46d0b62414582b8e7))
* allow MIME types of HEIF families ([23710c4](https://github.com/ayuki-joto/decidim-cfj/commit/23710c444db2d50435004ba0b520a529742648e9))
* allow multiple format of HEIF ([184c0b1](https://github.com/ayuki-joto/decidim-cfj/commit/184c0b1b907389cd51fa4f0504de3a08f1900b38))
* allow options in `preview` ([b4c3d57](https://github.com/ayuki-joto/decidim-cfj/commit/b4c3d576b668850686958e895c736ed7f40baac6))
* command initialized error ([07b46e5](https://github.com/ayuki-joto/decidim-cfj/commit/07b46e5bfbeaa830d44d15ded520d46f583da3f0))
* cookie_orderable.rb ([a11267d](https://github.com/ayuki-joto/decidim-cfj/commit/a11267d308fddca19e8c3f398dfa213ac55b4564))
* delete.rake ([a41ffa2](https://github.com/ayuki-joto/decidim-cfj/commit/a41ffa27e7e3e031b48cb67f2fcb209e21474738))
* deploy action ([1c7ba82](https://github.com/ayuki-joto/decidim-cfj/commit/1c7ba8231272f26a251c8fe6413b8856c9a73b7c))
* deploy.yml ([cc88e28](https://github.com/ayuki-joto/decidim-cfj/commit/cc88e28c33483fd48f3114ef10d4032ed9bba53d))
* deploy.yml version ([5b7fd5d](https://github.com/ayuki-joto/decidim-cfj/commit/5b7fd5d451f0fae8fff7ef24c7424b70ef18570f))
* deployments nginx conf ([cad7aba](https://github.com/ayuki-joto/decidim-cfj/commit/cad7abafdc7e52d1fa5dbf1e9bb52f4166bfeddf))
* Dockerfile ([d239c03](https://github.com/ayuki-joto/decidim-cfj/commit/d239c037daf1ed81bfb2cac5e265d16df02aa07b))
* error ([01f9552](https://github.com/ayuki-joto/decidim-cfj/commit/01f9552007bf6a66cb1edda1f12306507f46e692))
* force to use ImageProcessing ([c1ce6e8](https://github.com/ayuki-joto/decidim-cfj/commit/c1ce6e84b8f527bf6b5f5258dcfac585d148aac0))
* html editor ([75fe075](https://github.com/ayuki-joto/decidim-cfj/commit/75fe075f4677f09f61cb4c75aa80b8f4d2fb8626))
* lint ([5197479](https://github.com/ayuki-joto/decidim-cfj/commit/51974792c2dac1825847306b7e8589008ca72a60))
* lint ([9affdeb](https://github.com/ayuki-joto/decidim-cfj/commit/9affdeb5aa236e3ef5465c7b53091a1b3e1a1536))
* lint ([0f16659](https://github.com/ayuki-joto/decidim-cfj/commit/0f166592f0c2efda0244443105f176efb3121040))
* module name ([b6e13b1](https://github.com/ayuki-joto/decidim-cfj/commit/b6e13b1d0f870220e3df25d5569049e1bd6ffcff))
* nginx conf ([34ce786](https://github.com/ayuki-joto/decidim-cfj/commit/34ce78617ce3c160fdb1d20d5a95d4fe77ae8070))
* options of Capybara driver ([e17316d](https://github.com/ayuki-joto/decidim-cfj/commit/e17316dcfab231e3d451ef3d60eae516a53b9b03))
* refactor update Gemfile.lock ([b131005](https://github.com/ayuki-joto/decidim-cfj/commit/b1310055bb8fca478d7f85e3bde4557310d92ab2))
* remove cookie_orderable.rb ([f94258c](https://github.com/ayuki-joto/decidim-cfj/commit/f94258c99ed008a53a2092cb898c43181138f44f))
* remove decidim comments from Dockerfile ([c41c69d](https://github.com/ayuki-joto/decidim-cfj/commit/c41c69d3657dd1c220fdf5ae7d18ee943d55d23e))
* remove original decidim-comments; use default one ([51f8354](https://github.com/ayuki-joto/decidim-cfj/commit/51f83547d5a739430254b49fc3c29713b04d4ad5))
* remove proposals orderable param ([70656a8](https://github.com/ayuki-joto/decidim-cfj/commit/70656a8074144918b1c9e25f82f073649f25b53f))
* remove unused param ([2871c0d](https://github.com/ayuki-joto/decidim-cfj/commit/2871c0dbb06d4f87e40b021bd12667813e8cdec8))
* rubocop ([fe24dab](https://github.com/ayuki-joto/decidim-cfj/commit/fe24dabd91ad8c28f987f65e8ad0e1ca46750d81))
* rubocop ([ab18105](https://github.com/ayuki-joto/decidim-cfj/commit/ab18105a14953a9542e6ae070962bfa0ddc14e3f))
* skip test ([31c6ada](https://github.com/ayuki-joto/decidim-cfj/commit/31c6ada4798f79d2c295f5f77d00417fd2b75675))
* some bug ([e042f4d](https://github.com/ayuki-joto/decidim-cfj/commit/e042f4dcce085de750c42b6809722f5d69a84470))
* update docs ([4115fa6](https://github.com/ayuki-joto/decidim-cfj/commit/4115fa65d4346e7f57456f1c4f0f3820754bbbf9))
* user upload image error ([36e9c63](https://github.com/ayuki-joto/decidim-cfj/commit/36e9c63c10cd85c9ee0e952f0991fb4c03f134b2))


### Reverts

* 210; Fixed in v0.25.5 ([274f858](https://github.com/ayuki-joto/decidim-cfj/commit/274f858168423808afba2ffaca41e420a321bf59))
* 366 ([e3118c5](https://github.com/ayuki-joto/decidim-cfj/commit/e3118c54f5bb228a6b6d61f9a7a43c96c6387fce))
